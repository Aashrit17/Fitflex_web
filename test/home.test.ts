...
test.describe('Home Page Tests', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto('http://localhost:5173/dashboard'); // Replace with your actual dashboard route
  });
  ...
  test('should logout the user and redirect to login', async ({ page }) => {
    ...
    await expect(page).toHaveURL('http://localhost:5173/'); // Update URL if needed
  });
